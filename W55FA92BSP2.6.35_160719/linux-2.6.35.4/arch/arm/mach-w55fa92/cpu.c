...
void w55fa92_pm_suspend(int nvt_mode)
{
	...
	__raw_writel((__raw_readl(REG_MISSR) & ~0x00FF00C0) | (ADC_WE|RTC_WE|GPIO_WE|EMAC_WE), REG_MISSR);
	...
	__raw_writel(0x0101011F , REG_AHBCLK);
