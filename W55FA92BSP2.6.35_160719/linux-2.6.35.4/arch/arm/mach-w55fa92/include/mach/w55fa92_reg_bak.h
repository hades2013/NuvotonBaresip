...
#define UART_ISR_HW_Tout_INT            BIT28           // Time out Interrupt pin status#define UART_ISR_HW_Modem_INT           BIT27           // MODEM Status Interrupt pin status
...
#define REG_AR_AGC1		(AR_BA+0x004)	// R/W: 	Audio Record AGC control register
		...
		#define ATTACK			NVTBIT(11, 0)		// Attack time

#define REG_AR_AGC2		(AR_BA+0x008)	// R/W: 	Audio Record AGC control register		
		#define RECOVERY			NVTBIT(27, 16)		// Recovery time
