											...
											void *arg)
{
	...
	for(i=0;i<CONFIG_VIN_DEV1_PREVIEW_BUF_NO;i++)
...
static void vin_set_init(struct file *file)
{
	...
	for(i=0;i<CONFIG_VIN_DEV1_ENCODE_BUF_NO;i++)
	{
...
#if 1
		for(buf_num=0; buf_num< CONFIG_VIN_DEV1_PREVIEW_BUF_NO; buf_num=buf_num+1)
										...
										void *arg)
{
	...
	if (v4l2buff.index >= CONFIG_VIN_DEV1_ENCODE_BUF_NO)
	{
							...
							void *arg)
{
	...
	s_packet_info.i32PipeBufNo = CONFIG_VIN_DEV1_PREVIEW_BUF_NO;	
							...
							void *arg)
{
	...
	s_planar_info.i32PipeBufNo = CONFIG_VIN_DEV1_ENCODE_BUF_NO;	
	...
	s_planar_info.i32CurrBufIndex = priv->grab_sync;					/* CurrrntBufIdx always following priv->grab_sync in DEV1*/
													...
													void *arg)
{
	...
	if (priv->i32MappingBuf >= (CONFIG_VIN_DEV1_ENCODE_BUF_NO + CONFIG_VIN_DEV1_PREVIEW_BUF_NO))
	{//start form 0
										...
										void *arg)
{
	...
	offset = priv->videombuf.offsets[priv->grab_sync+CONFIG_VIN_DEV1_ENCODE_BUF_NO];
