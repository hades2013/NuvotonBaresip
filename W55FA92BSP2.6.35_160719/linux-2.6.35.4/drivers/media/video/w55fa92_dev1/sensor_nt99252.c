...
static struct NT_RegValue g_sNT99252_Init[] = 
{//
	#include "NT99252/NT99252_Init.dat" 
};

static struct NT_RegValue g_sNT99252_UXGA[] = 
{//24M sensor clock. 64MHz pixel clock
  	#include "NT99252/NT99252_UXGA_PCLK_64MHz.dat"
};
static struct NT_RegValue g_sNT99252_HD720[] = 
{//24M sensor clock. 64MHz pixel clock
	#include "NT99252/NT99252_HD720_PCLK_64MHz.dat"
};


static struct NT_RegValue g_sNT99252_SVGA[] = 
{//24M sensor clock. 64MHz pixel clock
...
static struct NT_RegTable g_NT99252_InitTable[] =
{
...
static __u8 g_uOvDeviceID= 0x6C;	// NT99252
...
static void NTSetResolution(int index)
{
...
#endif
	uTableSize = g_NT99252_InitTable[0].uTableSize;
	...
	uTableSize = g_NT99252_InitTable[index].uTableSize;
	psRegValue = g_NT99252_InitTable[index].sRegTable;
	for(i=0;i<uTableSize; i++, psRegValue++){
		udelay(10);
		DrvVideoIn_I2cWriteNT(uDeviceID, (psRegValue->uRegAddr), (psRegValue->uValue));
	}
...
static void NT99252RegConfig(void)
{
  	__u32 i;
	__u16 uTableSize;
	__u8  uDeviceID;
	...
	uTableSize = g_NT99252_InitTable[REG_VALUE_INIT].uTableSize;
	psRegValue = g_NT99252_InitTable[REG_VALUE_INIT].sRegTable;
	uDeviceID = g_uOvDeviceID;
...
static __s32 InitSensor(__u32 u32Sensor, void *priv)
{
	...
	printk("Init NT_99252 in port 1\n");
...
/*================================================== V4L2 User Ctrl ================================================== */
#endif 
static NVT_SENSOR_T nvt_sensor_NT99252 = {
...
{
	*sensor_intf = (NVT_SENSOR_T*)(&nvt_sensor_NT99252);
	return 0;
}
#endif 
