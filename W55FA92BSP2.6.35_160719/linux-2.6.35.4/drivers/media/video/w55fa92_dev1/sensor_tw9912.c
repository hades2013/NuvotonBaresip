...
{
	0x88,			/* If pin SIAD high, 8 bits slave address = 0x8A */				
					/* If pin SIAD low, 8 bits slave address = 0x88 */	
};
...
#endif 
#ifdef CONFIG_NTSC_SYSTEM_DEV1
#define CROP_START_X	0x7A
#define CROP_START_Y	0x24	
#endif
#ifdef CONFIG_PAL_SYSTEM_DEV1
#define CROP_START_X	4
#define CROP_START_Y	50
#endif
