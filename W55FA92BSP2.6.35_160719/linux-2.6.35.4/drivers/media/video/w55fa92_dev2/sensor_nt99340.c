...
#define CHIP_VERSION_H		0x3000	//==>0x34
#define CHIP_VERSION_L		0x3001	//==>0x00
#define NT99340_CHIP_ID		0x3400
...
static struct NT_RegValue g_sNT99340_Init[] = 
{//20MHz sensor clock
	#include "NT99340/NT99340_Init.dat" 
};


static struct NT_RegValue g_sNT99340_QXGA[] = 
{//20MHz sensor clock
	#include "NT99340/NT99340_QXGA_PCLK_64MHz.dat"
};


static struct NT_RegValue g_sNT99340_FULLHD[] = 
{//20MHz sensor clock
	//#include "NT99340/NT99340_FULLHD_PCLK_64MHz.dat"
	#include "NT99340/NT99340_1924x1090_PCLK_64MHz.dat"
};


static struct NT_RegValue g_sNT99340_HD720[] = 
{//20MHz sensor clock
  	#include "NT99340/NT99340_HD720_PCLK_64MHz.dat"
};

static struct NT_RegTable g_NT99340_InitTable[] =
{
...
static __u8 g_uOvDeviceID= 0x76;	// nt99340
...
{
	UINT8 u8Data;
	volatile UINT16 u32Delay = 0x100;
...
static void NTSetResolution(int index)
{
	...
	uTableSize = g_NT99340_InitTable[0].uTableSize;
	...
	uTableSize = g_NT99340_InitTable[index].uTableSize;
	psRegValue = g_NT99340_InitTable[index].sRegTable;
	for(i=0;i<uTableSize; i++, psRegValue++){
		udelay(10);
		DrvVideoIn_I2cWriteNT(uDeviceID, (psRegValue->uRegAddr), (psRegValue->uValue));
	}
...
*/
static void NT99340RegConfig(void)
{
  	__u32 i;
	__u16 uTableSize;
	__u8  uDeviceID;
	...
	uTableSize = g_NT99340_InitTable[REG_VALUE_INIT].uTableSize;
	psRegValue = g_NT99340_InitTable[REG_VALUE_INIT].sRegTable;
	uDeviceID = g_uOvDeviceID;
...
static __s32 InitSensor(__u32 u32Sensor, void *priv)
{
	...
	/* Sensor subsample resolution (1280, 720)*/
...
static S_NTSuppResol s_asNTSuppResolTable[NT_RESOL_SUPP_CNT] = {
	...
	{1920, 1088, REG_VALUE_FULLHD},
	{2048, 1536, REG_VALUE_QXGA}
};
...
/*================================================== V4L2 User Ctrl ================================================== */
#endif 
static NVT_SENSOR_T nvt_sensor_nt99340 = {
...
{
	*sensor_intf = (NVT_SENSOR_T*)(&nvt_sensor_nt99340);
	return 0;
}
#endif 
