...
static struct HM_RegValue g_sHM1375_HD720[] = 
{
...
static struct HM_RegValue g_sHM1375_VGA[] = 
{
...
#if 0
struct HM_RegValue g_sHM1375_50Hz[] = 
{
	{0x0542, 0x00},
	{0x0543, 0xFA},
};

struct HM_RegValue g_sHM1375_60Hz[] = 
{
	{0x0540, 0x00},
	{0x0541, 0xDA},
};
#endif
static struct HM_RegTable g_HM1375_InitTable[] =
{
...
static __u8 g_uOvDeviceID= 0x48;	// hm1375
...
static void HMSetResolution(int index)
{
	...
	uTableSize = g_HM1375_InitTable[index].uTableSize;
	psRegValue = g_HM1375_InitTable[index].sRegTable;
...
#endif
static void HM1375RegConfig(void)
{
  	__u32 i;
	__u16 uTableSize;
	__u8  uDeviceID;
	...
	uTableSize = g_HM1375_InitTable[REG_VALUE_VGA].uTableSize;
	psRegValue = g_HM1375_InitTable[REG_VALUE_VGA].sRegTable;
	uDeviceID = g_uOvDeviceID;
...
static __s32 InitSensor(__u32 u32Sensor, void *priv)
{
	...
	schedule_mdelay(10);
#endif							
	vin_priv->pDevVin->Open(96000, 16000);
...
/*================================================== V4L2 User Ctrl ================================================== */
#endif 
static NVT_SENSOR_T nvt_sensor_hm1375 = {
...
{
	*sensor_intf = (NVT_SENSOR_T*)(&nvt_sensor_hm1375);
	return 0;
}
#endif 
