...
#if 0
#include <asm/arch/w55fa92_reg.h>
...
)
{
	...
	outp32(REG_GPIOA_PUEN+(s_sChannel.u32SDAPortIndex), inp32(REG_GPIOA_PUEN+s_sChannel.u32SDAPortIndex)|s_sChannel.u32SDAPinMask);
	outp32(REG_GPIOA_PUEN+(s_sChannel.u32SCKPortIndex), inp32(REG_GPIOA_PUEN+s_sChannel.u32SCKPortIndex)|s_sChannel.u32SCKPinMask);	
