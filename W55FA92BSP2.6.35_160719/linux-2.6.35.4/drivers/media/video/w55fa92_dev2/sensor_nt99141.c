...
static struct NT_RegValue g_sNT99141_Init[] = 
{
	#include "NT99141/NT99141_Init.dat"
};
static struct NT_RegValue g_sNT99141_HD720[] = 
{//20MHz sensor clock
	#include "NT99141/NT99141_HD720_PCLK_60MHz.dat"
};
static struct NT_RegValue g_sNT99141_SVGA[] = 
{//20MHz sensor clock
	#include "NT99141/NT99141_SVGA_PCLK_60MHz.dat"
};
static struct NT_RegValue g_sNT99141_VGA[] = 
{//20MHz sensor clock
  	#include "NT99141/NT99141_VGA_PCLK_60MHz.dat"
};
static struct NT_RegTable g_NT99141_InitTable[] =
{
...
static struct NT_RegValue g_sNT99141_16M_HD720[] = 
{//16MHz sensor clock
	#include "NT99141/NT99141_HD720_PCLK_48MHz.dat"
};
static struct NT_RegValue g_sNT99141_16M_SVGA[] = 
{//16MHz sensor clock
	#include "NT99141/NT99141_SVGA_PCLK_48MHz.dat"
};
static struct NT_RegValue g_sNT99141_16M_VGA[] = 
{//16MHz sensor clock
  	#include "NT99141/NT99141_VGA_PCLK_48MHz.dat"
};
static struct NT_RegTable g_NT99141_16M_InitTable[] =
{
	{g_sNT99141_Init,_REG_TABLE_SIZE(g_sNT99141_Init)},
	{g_sNT99141_16M_VGA,_REG_TABLE_SIZE(g_sNT99141_16M_VGA)},	
	{g_sNT99141_16M_SVGA,_REG_TABLE_SIZE(g_sNT99141_16M_SVGA)},		
	{g_sNT99141_16M_HD720,_REG_TABLE_SIZE(g_sNT99141_16M_HD720)},
	{0,0}
};
static __u8 g_uOvDeviceID= 0x54;	// nt99141
...
static void NTSetResolution(int index)
{
	...
	if(s_i32SensorClk > 16000){
		...
		uTableSize = g_NT99141_16M_InitTable[0].uTableSize;
		psRegValue = g_NT99141_16M_InitTable[0].sRegTable;
	}
	...
	if(s_i32SensorClk > 16000){
		...
		uTableSize = g_NT99141_16M_InitTable[index].uTableSize;
		psRegValue = g_NT99141_16M_InitTable[index].sRegTable;
	}
	for(i=0;i<uTableSize; i++, psRegValue++){
		udelay(10);
		DrvVideoIn_I2cWriteNT(uDeviceID, (psRegValue->uRegAddr), (psRegValue->uValue));
