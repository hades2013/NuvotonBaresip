...
#elif defined(CONFIG_W55FA92_ETH_PHY_LAN8720AI)
		//w55fa92_mdio_write(dev, ether->mii.phy_id,15,7);	//setting page7
		//w55fa92_mdio_write(dev, ether->mii.phy_id,14,0x0010);
		//if( w55fa92_mdio_read(dev, ether->mii.phy_id,14) != 0x0010 ) 
		//	printk("LAN8720AI Setting Fail..\n");
		//w55fa92_mdio_write(dev, ether->mii.phy_id,15,7);	//setting page7
		//w55fa92_mdio_write(dev, ether->mii.phy_id,12,0x79A);
		//if( w55fa92_mdio_read(dev, ether->mii.phy_id,12) != 0x79A ) 
		//	printk("LAN8720AI Setting Fail..\n");
		
		printk("LAN8720AI Register[%02d] : 0x%x\n",  2, w55fa92_mdio_read(dev, ether->mii.phy_id, 2));
		printk("LAN8720AI Register[%02d] : 0x%x\n",  3, w55fa92_mdio_read(dev, ether->mii.phy_id, 3));
#else 
	#error phy_id no defined
#endif
...
#elif defined(CONFIG_W55FA92_ETH_PHY_SR8201)
...
#if defined(CONFIG_W55FA92_ETH_PHY_LAN8720AI)
	*((unsigned volatile int *)(REG_GPIOH_DOUT)) |= 0x0200;
	printk("w55fa92_ether_init:reverse mdc\n");
#endif
