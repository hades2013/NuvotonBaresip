...
/* Check device for jpegcodec "/dev/video0" or "/dev/video1" */
	...
	{
		printf("\n************* Jpeg/Sensor demo ************\n");
		printf("0.Jpeg Decode Input & Output Test...                      [jpegIOPW.jpg -> decIOPW_NormalDecode.jpg]\n");	
		...
		printf("E.Jpeg Window Decode & Downscale Test (To FB Buffer)	  [thumbX.jpg	-> DecodeWinDownscale.dat & Panel]\n");
		printf("F.Jpeg Encode Primary & Thumbnail from FB buffer	  [No souce file-> Snapshot.jpg\n");
		printf("X.Exit ..\n");
		printf("");
		printf("\n*******************************************\n");
		printf("Select : \n"); 
    again:
    	...
    	{
		case 0x30:
			printf("0.Jpeg Decode Input & Output Test...\n");	
			jpegCodecIOPW();
			break;
    		case 0x31:
		...
		case 'c':case 'C':				
			...
			break;
		case 'e':case 'E':			
			printf("E.Jpeg Window Decode & Downscale Test (To FB Buffer)\n");
			jpegWindecDownscale();
			break;
		case 'f':case 'F':			
			printf("F.Jpeg Encode Primary & Thumbnail from FB buffer\n");
			jpegEncFB();
			break;
