...
int vin_main(void)
{
	...
	while((i32Opt = getopt(argc, argv, "s:e:p:t:uh")) != -1) {
		switch(i32Opt){
			...
			{
//				if(strcasecmp(optarg, "qvga") == 0){
//					s_sJpegEncFeat.eJpegEncThbSupp = eJPEG_ENC_THB_QVGA;
//				}
//				else{
//					s_sJpegEncFeat.eJpegEncThbSupp = eJPEG_ENC_THB_QQVGA;
//				}
...
//				s_sJpegEncFeat.bUpScale = TRUE;
	...
	*/
    ...
    ePreviewImgResol = eIMAGE_WQVGA;eIMAGE_QVGA;
    eEncodeImgResol =   eIMAGE_QVGA;
