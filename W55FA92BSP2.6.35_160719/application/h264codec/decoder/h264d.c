...
int InitFB()
{
	...
	g_u32VpostWidth = var.xres;
	g_u32VpostHeight = var.yres;
	fb_bpp = var.bits_per_pixel/8;	
...
//usleep(100);        
        ...
        FormatConversion((void *)pict_ptr, (char *)dec_mmap_addr, decoded_img_width, decoded_img_height, decoded_img_width, decoded_img_height);        	
