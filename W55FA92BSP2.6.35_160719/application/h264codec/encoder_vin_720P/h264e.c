...
#define     ENC_IMG_WIDTH   1280 //320
#define     ENC_IMG_HEIGHT  720 //240


#define dout_name1         "./enc720P.264"
#define dinfo_name        "./enc720P.txt"
...
int main(int argc, char **argv)
{
...
#endif    
    video_setting.bit_rate = 4096000;
    ...
    fcount = TEST_ROUND;
    system("/mnt/nand1-1/nvtbitio -p 0xb0000204 -b 28 -v 0");
    for (i=0; i < fcount; i++)
    {
